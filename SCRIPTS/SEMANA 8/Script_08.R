...
# f(x)=B0+B1x
#**B0 es cuando la X vale 0 (intercepto) y B1 es la (pendiente)** (Pendiente/B1= 
#*Si aumento X, cuánto se aumenta en Y?)
...
#**Gauss 1809**
# B0 y B1
# Minimizar la suma de los residuos al cuadrado = residuales al cuadrado y su 
#sumatoria.
...
# (En la tesis si vas a hacer una, primero explica que se cumplen todos los supuestos
#y los valores, de B0 y B1)
